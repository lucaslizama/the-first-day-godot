...
def pack(name, frames, out_dir):
    ...
    lines = [
        ...
        "",
        "; Generated by tools/pack_coworker_sprites.py - do not hand-edit.",
        "; %d frames at %d fps (%.4f s), in the order %s plays them."
        % (len(regions), FPS, len(regions) / FPS, os.path.basename(CLIPS[name])),
        "",
