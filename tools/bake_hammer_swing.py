...
def main():
    ...
    lines = [
        ...
        "",
        "; Generated by tools/bake_hammer_swing.py - do not hand-edit.",
        "; martillo_anim resampled at Unity's own %d fps: %d keys over %.4f s, looping."
        % (FPS, len(baked), stop),
        "; The swing is a pendulum from -80 to +80 degrees about Z and back.",
        "",
        "[resource]",
        'resource_name = "swing"',
        "length = %.6f" % stop,
